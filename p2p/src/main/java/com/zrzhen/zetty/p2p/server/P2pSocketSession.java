 ...
 */
public class P2pSocketSession extends SocketSession {

    private static final Logger log = LoggerFactory.getLogger(P2pSocketSession.class);

    public P2pSocketSession(AsynchronousSocketChannel socketChannel, Builder builder) {
