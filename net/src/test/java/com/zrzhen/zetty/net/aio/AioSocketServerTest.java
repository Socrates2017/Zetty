...
/**
 * @author chenanlian
 * aio socket server api demo
 */
public class AioSocketServerTest {
    private static final Logger log = LoggerFactory.getLogger(AioSocketServerTest.class);
        ...
        while (true) {
            ...
            channel.read(readBuffer, readBuffer, new CompletionHandler<Integer, ByteBuffer>() {
                ...
                public void completed(Integer result, ByteBuffer readBuffer) {
                    ...
                    try {
                        //将收到的消息原样返回
                        response = ByteBuffer.wrap((msg).getBytes("utf-8"));
