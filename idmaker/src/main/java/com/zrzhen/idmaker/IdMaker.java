...
public class IdMaker {
    ...
    public IdMaker(long workerId, long datacenterId) {
        if (workerId > idMeta.getMaxWorkerId() || workerId < 0) {
            throw new IllegalArgumentException(String.format("worker Id can't be greater than %d or less than 0", idMeta.getMaxWorkerId()));
        }
    ...
    public synchronized long nextId() {
        ...
        return ((timestamp - idMeta.getEpoch()) << idMeta.getTimestampLeftShift()) //
                | (datacenterId << idMeta.getDatacenterIdShift()) //
                | (workerId << idMeta.getWorkerIdShift()) //
                | sequence;
    }
    ...
    public static void main(String[] args) {
        IdMaker idWorker = new IdMaker(0, 0);
