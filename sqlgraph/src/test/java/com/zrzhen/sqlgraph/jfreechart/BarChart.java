package com.zrzhen.sqlgraph.jfreechart;

import com.zrzhen.sqlgraph.util.ChartUtils;
import com.zrzhen.sqlgraph.util.Serie;
...
public class BarChart {
    ...
    public ChartPanel createChart() {
        ...
        try {
            fos_jpg = new FileOutputStream("D:\\jfreechart2.jpg");
            ChartUtilities.writeChartAsJPEG(fos_jpg, 1.0f, chart, 1024, 420,null);
